...
@section('content-actions')
    <a href="{{ route('localidades.create') }}" class="btn btn-success"><i class="fas fa-plus"></i> Registar nueva
        Localidad</a>
@endsection
@section('css')
